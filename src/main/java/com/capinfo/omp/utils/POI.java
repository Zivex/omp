...
public class POI {
	 ...
	 * @throws Exception
     */
    public List<Omp_Old_Info> importEmployeeByPoi(InputStream fis) throws Exception {
     ...
     /*   for (int i = 11; i < rowNum; i++) {
			...
			Omp_Old_Info omp = new Omp_Old_Info(CountyId, StreetId, CommunityId, workername, workertel,
