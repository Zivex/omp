			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" role="main">
				<div>
					<div class="page-header">
						<h1>
							<i class="fa fa-user fa-fw"></i>服务商管理 <span id="backspan"><input type="button"
					...
					<div id="displayDiv">
						<div class="operatorDiv">
							<c:url var="queryForm" value="/admin/omp/ServiceProvider/lists.shtml" />
							<form:form id="command" role="form" class="form-inline" action="${queryForm }" method="post">
								...
								<a role="button" class="btn btn-primary" onclick="importInformation()">服务商信息导入</a>
