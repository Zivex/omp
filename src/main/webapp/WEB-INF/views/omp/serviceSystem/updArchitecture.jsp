			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"
				...
				<div>
					<div class="page-header">
						<h1>
							<i class="fa fa-user fa-fw"></i>修改服务体系<span id="backspan"><input
					...
					<div>
						...
						<div style="float: left; width: 50%;">
							...
							<input type="hidden" name="entity.createTime"  value="${ss.updateTime }">
						...
						<div style="float: right; width: 40%;" id="providers">
							<div>
								<form id="providersForm" role="form">
									...
									<div class="form-group">
										<label for="serviceType">服务类型</label> <select
											name="serviceType" id="serviceType" class="form-control">
						...
						for (var i = 0; i < data.length; i++) {
							...
							architecture
									.append("<tr><td><input type='radio' name='typeId' value='"+data[i].id+"'> "
											+ data[i].ok.key
											+ "</td><td>"
											+ data[i].serviceProvider.serviceName
											+ "</td><td><input type='hidden' class='serviceId' name='"+data[i].ok.key+"'value='"+data[i].sp_id+"' ><span>"+data[i].sname+"<span></td></tr>");
						}
						architecture
