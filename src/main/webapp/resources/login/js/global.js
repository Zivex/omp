...
$(document).ready(function(){
	...
	if(!!!$('.opt-panel').size() && !!!$('.system-switch').size()){
		$(document).click(function(e) {
			$(document).find('.opt-panel').hide().end().find('.system-switch').hide();
			$(document).find('.more-info').removeClass('active').end().find('.logo-icon').removeClass('active');
		});
	}
	
	if(!!!$('.more-bab-list').size()){
		$(document).click(function(e) {
			$(document).find('iframe').contents().find('.more-bab-list').hide();
			$(document).find('iframe').contents().find('.tab-more').removeClass('active');
		});	
	}
});
